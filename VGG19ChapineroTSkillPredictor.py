...
voteSetFile = 'chapineroSRandomVote4Predict_SchemIII.txt'
...
np.savetxt("randomIndexerS_ChapineroPredict4TSkill.csv", votesIndex, delimiter=",", fmt='%i')


print("________________________________Building TrueSkill Output File")
mu, sigma, fileName, zeroVotes, oneVotes, twoVotes, totalVotes = actualOneMatchSycleVoteTrueSkillExplorer(randomIndexerSPath = 'randomIndexerS_ChapineroPredict4TSkill.csv',
                                                                                                          imgSetSize = 5505,
                                                                                                          zoneName = "Chapinero")
